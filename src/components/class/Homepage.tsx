...
export default function Homepage() {
    ...
    return (
        <>
            {createdClassrooms && createdClassrooms.map && createdClassrooms.length > 0 ? (
                <>
            ...
            {joinedClassrooms && joinedClassrooms.map && joinedClassrooms.length > 0 ? (
                <>
            ...
            (!joinedClassrooms || joinedClassrooms.length === 0) ? (
                <Card title="You don't have any courses">
                    You haven't created or joined any courses. Click <b>CREATE</b> button
                    in navigation bar to create one.
                    <br />
                    After creating or joining a new course, it will appear here.
                </Card>
            ) : null}
        </>
    );
