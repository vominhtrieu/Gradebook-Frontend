...
import GradeReviewSection from "./class_detail/grade/grade_section/GradeReviewSection";
import GradeViewSection from "./class_detail/grade/grade_section/GradeViewSection";
              ...
              <TabPane tab="Grades" key="grades" style={TabPaneStyle}>
                {activeTab === "grades" &&
                  (classroom.isTeacher ? (
                    ...
                    <GradeViewSection teachers={classroom.teachers} />
                  ))}
              </TabPane>
              {classroom.isTeacher && (
                <TabPane
                  ...
                  style={TabPaneStyle}
                >
                  {activeTab === "grade_review" && <GradeReviewSection />}
                </TabPane>
              )}
            </Tabs>
          </div>
