...
export default function GradeReviewConversation() {
    ...
    useEffect(() => {
        ...
        mainContext.socket.on("newMessage", fetchData);
        fetchData();
        return () => {
            mainContext.socket.removeListener("newMessage")
        }
    }, [id, gradeDetailId, mainContext.socket]);
                            ...
                            <List.Item.Meta
                                ...
                                title={
                                    <>
                                        ...
                                        <span className="comment-date"> {moment(item.date).format("MMM DD")} </span>
                                    </>
                                }
